...
def show_pause_menu():
    ...
    CONTINUE_BUTTON = Button('play_rect.png', pos=(width / 2, height / 2 - 100),
                         text_input="CONTINUE", font=font, base_color="Black", hovering_color="White")
    OPTIONS_BUTTON = Button('play_rect.png', pos=(width / 2, height / 2),
