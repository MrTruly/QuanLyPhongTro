...
def options():
    ...
    while True:
        ...
        OPTIONS_BACK = Button(image_file='replay_button.png', pos=(
            400, 500), text_input=None, font=font, base_color="Black", hovering_color="Green")
        OPTIONS_BACK.changeColor(OPTIONS_MOUSE_POS)
        OPTIONS_BACK.update(screen)

        START_GAME_BUTTON = Button(image_file='replay_button.png', pos=(
            600, 500), text_input=None, font=font, base_color="White", hovering_color="Green")
        START_GAME_BUTTON.update(screen)

        # Draw border around the skin selection area
        # Adjust width and height based on button size and positions
        border_rect = pygame.Rect(10, 70, 350, 300)
        # Draw border with 2-pixel thickness
